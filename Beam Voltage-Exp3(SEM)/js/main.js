...
function execute() {
    ...
    if (value == 2) {
        if (magnification_range2 == 0) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "100x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/100x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 100x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "100x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/100x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 100x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "100x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/100x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 100x Magnification"
            }
        }
        if (magnification_range2 == 1) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "40x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/40x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 40x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "40x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/40x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 40x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "40x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/40x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 40x Magnification"
            }
        }
        if (magnification_range2 == 2) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "20x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/20x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 20x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "20x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/20x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 20x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "20x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/20x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 20x Magnification"
            }
        }
        if (magnification_range2 == 3) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "10x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/10x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 10x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "10x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/10x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 10x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "10x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/10x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 10x Magnification"
            }
        }
        if (magnification_range2 == 4) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "4x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/4x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 4x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "4x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/4x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 4x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "4x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/4x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 4x Magnification"
            }
        }
        if (magnification_range2 == 5) {
            if (voltage_range2 == 0) {
                document.getElementById("magnificationtext2").innerHTML = "2x";
                document.getElementById("voltagetext2").innerHTML = "5 Kilo Volts";
                document.getElementById("image_display").src = "./images/2x_5.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 5kV and 2x Magnification"
            }
            if (voltage_range2 == 1) {
                document.getElementById("magnificationtext2").innerHTML = "2x";
                document.getElementById("voltagetext2").innerHTML = "10 Kilo Volts";
                document.getElementById("image_display").src = "./images/2x_10.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 10kV and 2x Magnification"
            }
            if (voltage_range2 == 2) {
                document.getElementById("magnificationtext2").innerHTML = "2x";
                document.getElementById("voltagetext2").innerHTML = "20 Kilo Volts";
                document.getElementById("image_display").src = "./images/2x_20.PNG"
                document.getElementById("demo4").innerHTML = "3. Now you see Image at 20kV and 2x Magnification"
            }
        }
    }
    ////////////////////////////////////////////////////////////
